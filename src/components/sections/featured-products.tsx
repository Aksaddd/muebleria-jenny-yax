...
/* ═══════════════════════════════════════════════════════════════════════════
   ...
   Premium product showcase with 4 featured items + custom order CTA
   ═══════════════════════════════════════════════════════════════════════════ */
...
// Featured products data - consistent category-style naming
const featuredProducts = [
  {
    id: "ropero",
    nameEs: "Ropero",
    nameEn: "Wardrobe",
    descEs: "Madera maciza • Acabado brillante",
    descEn: "Solid wood • Polished finish",
    image: "/images/hero/workshop-roperos.webp",
    altEs: "Roperos de madera siendo terminados a mano en el taller",
    altEn: "Wooden wardrobes being hand-finished in the workshop",
  },
  {
    id: "trinchante",
    nameEs: "Trinchante",
    nameEn: "Sideboard",
    descEs: "Diseño clásico • Múltiples compartimentos",
    descEn: "Classic design • Multiple compartments",
    image: "/images/hero/storefront.webp",
    altEs: "Trinchantes y muebles exhibidos en la tienda",
    altEn: "Sideboards and furniture displayed in the store",
  },
  {
    id: "librero",
    nameEs: "Librero",
    nameEn: "Bookshelf",
    descEs: "Espacios amplios • Madera de pino",
    descEn: "Spacious shelves • Pine wood",
    image: "/images/1472360117443877582.webp",
    altEs: "Madera de calidad lista para fabricar libreros",
    altEn: "Quality wood ready to craft bookshelves",
  },
  {
    id: "buro",
    nameEs: "Buró",
    nameEn: "Nightstand",
    descEs: "Compacto • Ideal para recámaras",
    descEn: "Compact • Ideal for bedrooms",
    image: "/images/7711001662288611009.webp",
    altEs: "Muebles empacados listos para entrega a domicilio",
    altEn: "Furniture packed and ready for home delivery",
  },
];
...
export function FeaturedProducts() {
  ...
  return (
    ...
    >
      <Container>
        {/* ─────────────────────────────────────────────────────────────────
            Section Header — with breathing room and authority
            ───────────────────────────────────────────────────────────────── */}
        ...
        {/* ─────────────────────────────────────────────────────────────────
            Custom Order Banner — distinct, clear separation
            ───────────────────────────────────────────────────────────────── */}
        <div
          className={cn(
            "mt-14 md:mt-18",
        ...
        {/* ─────────────────────────────────────────────────────────────────
            Footer: View All + Trust Line + Facebook (secondary)
            ───────────────────────────────────────────────────────────────── */}
...
/* ───────────────────────────────────────────────────────────────────────────
   Product Card Component — subtle hover lift
   ─────────────────────────────────────────────────────────────────────────── */
...
function ProductCard({ product, lang, cardContent }: ProductCardProps) {
  const name = lang === "es" ? product.nameEs : product.nameEn;
  const desc = lang === "es" ? product.descEs : product.descEn;
  const alt = lang === "es" ? product.altEs : product.altEn;
  ...
  return (
    ...
    >
      ...
      <div className="p-5">
        ...
        <p className="mt-1.5 text-small text-text-subtle">
          {desc}
        </p>
